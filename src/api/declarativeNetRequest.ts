...
export class TodoDeclarativeNetRequest {
  DYNAMIC_RULESET_ID: string = "_dynamic";
  GETMATCHEDRULES_QUOTA_INTERVAL: number = 10;
  GUARANTEED_MINIMUM_STATIC_RULES: number = 30000;
  MAX_GETMATCHEDRULES_CALLS_PER_INTERVAL: number = 20;
  MAX_NUMBER_OF_DYNAMIC_AND_SESSION_RULES: number = 5000;
  MAX_NUMBER_OF_REGEX_RULES: number = 1000;
  MAX_NUMBER_OF_STATIC_RULESETS: number = 50;
  SESSION_RULESET_ID: string = "_session";
